...
【右侧交易减仓信号】（趋势破坏时的操作指引）
牛市中不需要预判顶部，但必须识别趋势破坏信号：

| 信号类型 | 触发条件 | 建议操作 |
|---------|---------|---------|
| 均线破位 | 跌破20日均线+当日放量>1.5倍均量 | 减仓30% |
| 趋势反转 | 跌破60日均线 | 减仓50% |
| 量价背离 | 创新高但量能萎缩>30%（缩量新高） | 减仓20%，提高警惕 |
| 板块轮动 | 板块资金连续3日净流出 | 观察，准备减仓 |
| MACD死叉 | 日线MACD死叉+股价跌破5日线 | 减仓20% |

**移动止盈设置**（锁定利润，不与趋势对抗）：
| 浮盈区间 | 止盈位设置 | 逻辑 |
|---------|-----------|------|
| 浮盈20% | 止盈位=成本+10% | 保护一半利润 |
| 浮盈50% | 止盈位=成本+30% | 保护60%利润 |
| 浮盈100% | 止盈位=成本+60% | 保护60%利润 |
| 浮盈200% | 止盈位=最高点回撤15% | 趋势跟踪止盈 |
